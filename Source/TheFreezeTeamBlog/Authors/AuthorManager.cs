namespace TheFreezeTeamBlog.Authors
{
  ...
  public class AuthorManager
  {
    ...
    public AuthorManager()
    {
      ...
      authors.Add("Josh Welty", new Author { Name = "Josh Welty", CodingGame = "CodingGameId", Facebook = "FacebookId", Twitter = "Twitter", AvatarPath = "/authorAvatars/noavatar.jpg", Discord= "497944319227985920" });
